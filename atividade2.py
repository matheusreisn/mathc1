...
def relatorio_geral():
    ...
    for produto in inventario:
        print(
            f"Nome: {produto[2]}, Categoria: {produto[1]}, Código: {produto[0]}, Quantidade: {produto[3]}, Preço: {produto[4]}"
        )
...
╚═╝░░░░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝╚══════╝  ╚═╝░░╚═╝░░░╚═╝░░░╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝╚═════╝░╚═╝╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝
    ...
    for produto in inventario:
        if produto[1].lower() == categoria.lower() and categoria.isalpha():
            print(
                f"Nome: {produto[2]}, Código: {produto[0]}, Quantidade: {produto[3]}, Preço: {produto[4]}"
            )
    print("Fim do relatório.")
